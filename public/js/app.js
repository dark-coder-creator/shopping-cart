...
function updateCart(test) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', test).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var test = JSON.parse(btn.dataset.test);
    updateCart(test);
  });
...
__webpack_require__(/*! /home/c_saravanan_mohandas/Desktop/s-cart/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/c_saravanan_mohandas/Desktop/s-cart/resources/scss/app.scss */"./resources/scss/app.scss");
